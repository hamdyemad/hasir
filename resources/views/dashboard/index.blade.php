            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    @component('common-components.widget')
                        ...
                        @slot('icons') mdi mdi-account-outline float-right @endslot
                        @slot('title') الموظفين @endslot
                        @slot('price') {{ $usersCount }} @endslot
                    @endcomponent
                </div>
                <div class="col-12 col-md-6 col-lg-3">
                    @component('common-components.widget')
                        @slot('route') {{ route('projects.index') }} @endslot
                        @slot('icons') mdi mdi-projector-screen float-right @endslot
                        @slot('title') المشاريع @endslot
                        @slot('price') {{ $projectsCount }} @endslot
                    @endcomponent
                </div>
                <div class="col-12 col-md-6 col-lg-3">
                    @component('common-components.widget')
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    @component('common-components.widget')
                        @slot('route') {{ route('clients.index') }} @endslot
                        @slot('icons') mdi mdi-account-badge-horizontal float-right @endslot
                        @slot('title') العملاء @endslot
                        @slot('price') {{ $clientsCount }} @endslot
                    @endcomponent
                </div>
            </div>
            <!-- end row -->
