<section class="features pt-5">
    <div class="container">
        <div class="wow jello"  data-wow-offset="100">
            @include('frontend.inc.heading', ['heading' => 'مميزاتنا'])
        </div>
            ...
            <div class="col-12 col-md-6">
                <div class="card wow fadeInRight" data-wow-offset="50" data-wow-delay="0.1s">
                    ...
                    <div class="card-body">
                        ...
                        توفر الرقي والأصالة في آن واحد بأيدي خبراء نثق بإبداعهم لبناء منشآت و
                        مساكن تليق بعملائنا.
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="card wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.2s">
                    ...
                    <div class="card-body">
                        ...
                        أو مراكز تجارية أو منشآت خاصة مع جودة عالية وخدمة تليق بكم.
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
                <div class="card wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.4s">
                    ...
                    <div class="card-body">
                        ...
                        وذات رؤية ليلية بالإضافة الى نظام إطفاء متكامل للحالات الطارئة.
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
                <div class="card wow fadeInRight" data-wow-offset="50" data-wow-delay="0.5s">
                    ...
                    <div class="card-body">
                        ...
                        من التحكم في الإنارة عن طريق تطبيق خوارزم
                        بالإضافة الى توفير نظام الطاقة الشمسية وابواب مقاومة
                        للرطوبة لمعيشة مريحة.
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
